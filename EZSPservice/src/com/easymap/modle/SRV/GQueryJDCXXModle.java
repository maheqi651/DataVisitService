	...
	/*	String exfiedclumstr="";
		...
		/*	//前些列结束
			...
			if(mtexlist!=null)
			{
				...
				{
					ryxxdb.setConnecttion(DBCPPools.getInstance().getConnection(driver,url, username, password));
					Object[] ryxxexmt=ryxxdb.executeQueryRS1("select FIELDNAME,FIELDVALUE from wp_jdc_jbxx_mt where id=?", new Object[]{ID});
