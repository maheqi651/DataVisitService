...
public class KvQuery implements IStreamQAS {
	JSONObject jo;
	SimpleDateFormat sdf = new SimpleDateFormat(Constants.HBASE_DATE_FORMAT);

	public KvQuery(JSONObject jsonS) {
		jo = jsonS;
	}
	@Override
	public KvPage execute() throws QueryConditionsConstructException, EzBigDataConfigException {
		...
		Object stopRowkeyObj = params.get("stopRowkey");
		...
		KvPage kp =ebdkq.executeQuery(Strings.nullToEmpty((String) rowkey),Strings.nullToEmpty((String) stopRowkeyObj), beginTimestamp,endTimestamp,
